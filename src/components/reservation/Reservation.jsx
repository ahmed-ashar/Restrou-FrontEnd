...
const optionsTiming = [
  ...
  { value: "3", label: "10:00 AM - 12:00 AM" },
  { value: "4", label: "11:30 AM - 01:30 AM" },
  { value: "5", label: "12:00 AM - 02:00 AM" },
  { value: "6", label: "01:30 AM - 03:30 AM" },
  { value: "7", label: "03:30 AM - 05:30 AM" },
  { value: "8", label: "04:00 AM - 06:00 AM" },
  { value: "9", label: "05:30 AM - 07:30 AM" },
];
      ...
      <form action="" className="reservation-form grid">
        ...
        <div className="reservation-group grid">
          ...
          <button className="button reservation-button">
            Book Now <FaCircleArrowRight className="button-icon" />
          </button>
        </div>
      </form>
    </section>
